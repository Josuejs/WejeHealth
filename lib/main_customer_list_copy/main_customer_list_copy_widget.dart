...
import 'main_customer_list_copy_model.dart';
export 'main_customer_list_copy_model.dart';

class MainCustomerListCopyWidget extends StatefulWidget {
  const MainCustomerListCopyWidget({Key? key}) : super(key: key);

  @override
  _MainCustomerListCopyWidgetState createState() =>
      _MainCustomerListCopyWidgetState();
}

class _MainCustomerListCopyWidgetState extends State<MainCustomerListCopyWidget>
    with TickerProviderStateMixin {
  late MainCustomerListCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainCustomerListCopyModel());
