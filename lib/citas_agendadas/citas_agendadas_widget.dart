...
class CitasAgendadasWidget extends StatefulWidget {
  ...
  final PatientsInfoRecord? idPacientes2;
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'mw95lfsr' /* Schedule Appointments */,
            ),
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<PatientsInfoRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<PatientsInfoRecord> listViewPatientsInfoRecordList =
                          snapshot.data!;
                      return ListView.builder(
                        ...
                        itemCount: listViewPatientsInfoRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewPatientsInfoRecord =
                              listViewPatientsInfoRecordList[listViewIndex];
                          return Padding(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(12.0),
                                      child: Image.network(
                                        listViewPatientsInfoRecord.imgProfile!,
                                        width: 120.0,
                                        height: 100.0,
                                        fit: BoxFit.cover,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        await launchUrl(Uri(
                                            scheme: 'mailto',
                                            path: listViewPatientsInfoRecord
                                                .email!,
                                            query: {
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        final patientsInfoUpdateData = {
                                          'EstatusCita': FieldValue.delete(),
                                        };
                                        await listViewPatientsInfoRecord
                                            .estatusCita!
